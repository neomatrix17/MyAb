...
namespace AdressenManagement.Module
{
    ...
    public partial class AdresseAendern : ViewController
    {
        public AdresseAendern()
        {
            InitializeComponent();
        ...
        public void AdresseAendernControler_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            if (!(View == null))
            {
                ...
                DetailView detailView = Application.CreateDetailView(objectSpace, objectSpace.GetObjectByKey<BusinessLogic.Basis.Adresse>(((BusinessLogic.Basis.Termin)selectedTermin).Adresse.Oid));
