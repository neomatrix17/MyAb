...
namespace AdressenManagement.Module.Web
{
	...
	public partial class DateiDisableEnfAdd : ViewController
	{
		public DateiDisableEnfAdd()
		{
			InitializeComponent();
		...
		protected override void OnActivated()
		{
			...
			//Frame.GetController(Of RemoveViewVariantsControler )()..Active("NestedListView") = False
