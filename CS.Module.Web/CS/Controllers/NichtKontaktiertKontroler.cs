...
namespace AdressenManagement.Module.Web
{
	...
	public partial class NichtKontaktiertKontroler : ViewController
	{
		public NichtKontaktiertKontroler()
		{
			InitializeComponent();
		...
		public void NichtKontaktiert_Execute(object sender, SimpleActionExecuteEventArgs e)
		{
