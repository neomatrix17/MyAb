...
namespace AdressenManagement.Module.Web
{
	...
	public partial class TerminWichtigInformationControler : ViewController<DetailView>
	{
		public TerminWichtigInformationControler()
		{
			InitializeComponent();
		...
		protected override void OnActivated()
		{
			...
			foreach (StaticTextDetailItem item in View.GetItems<StaticTextDetailItem>())
			{
