...
namespace AdressenManagement.Module.Web
{
	...
	public partial class MyAppointmentsTextSearchControler : ViewController<ListView>
	{
		public MyAppointmentsTextSearchControler()
		{
			InitializeComponent();
			
			TargetObjectType = typeof(BusinessLogic.Basis.Termin);
		...
		private List<string> GetFullTextSearchProperties()
		{
			...
			searchProperties.AddRange(new[] {"Subject", "Description", "StartOn", "EndOn", "TelefonNummer", "TelefonNummer2", "TelefonNummer3"});
